...
namespace TrabalhoPratico1Grafo
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.Write("Qual dos Grafos deseja utilizar: \n1 - Grafo com MA \n2 - Grafo com LA");
            ...
            switch (opcao)
            {
                case 1: //Grafo MA
                    ...
                    grafoMA = new Grafo(int.Parse(Console.ReadLine()));

                    while (executar == 1)
                    {

                        int escolha = EscolhaMenu();
                        ExecutaOpcao(ref grafoMA, escolha);
                ...
                case 2: // Grafo LA
                    ...
                    while (executar == 1)
                    {
                        ...
                        int escolha = EscolhaMenuLA();
                        ExecutaOpcaoLA(ref grafoLA, escolha);
        ...
        public static int EscolhaMenuLA()
        {
            Console.Clear();
            ...
            Console.WriteLine("O que deseja fazer com o grafo:");
            Console.WriteLine("1 - Ordem do Grafo");
            Console.WriteLine("2 - Inserir vértice no Grafo");
            Console.WriteLine("3 - Remover vértice no Grafo");
            Console.WriteLine("4 - Inserir Aresta");
            Console.WriteLine("5 - Remover Aresta");
            Console.WriteLine("6 - Grau de um vértice");
            Console.WriteLine("7 - Verificar se o Grafo está completo");
            Console.WriteLine("8 - Verificar se o Grafo é regular");            
            Console.WriteLine("9 - Mostrar Lista de Adjacência");
            Console.WriteLine("10 - Mostrar a sequência de graus do Grafo");
            Console.WriteLine("11 - Mostrar vértices adjacentes de um determinado vértice");
            Console.WriteLine("12 - Verificar se um determinado vértice é isolado");
            Console.WriteLine("13 - Verificar se o vértice é par");
            Console.WriteLine("14 - Verificar se o vértice é impar");
            Console.WriteLine("15 - Verificar se há adjacência entre 2 vértices");
            Console.Write("Escolha: ");
            return escolha = int.Parse(Console.ReadLine());


        }
        public static void ExecutaOpcaoLA(ref GrafoLA grafo, int escolha)
        {
            ...
            switch (escolha)
            {
                ...
                case 9: //Lista de Adjacência
                    grafo.ShowLA();
                    break;

                case 10: //Sequência de Graus
                    Console.WriteLine("Sequência de graus do Grafo:");
                    grafo.SequenciaGraus();
                    break;

                case 11: //Vértices adjacentes de um vértice
                    Console.WriteLine("Escolha qual vértice deseja ver os vértices adjcentes: ");
                    grafo.NomesVertices();
                    vertice = grafo.GetVertice(int.Parse(Console.ReadLine()));
                    grafo.VerticesAdjacentes(vertice);
                ...
                case 15: //Adjacência entre 2 vértices
                    Console.WriteLine("Escolha quais vértices deseja verificar se há adjacência entre eles: ");
                    grafo.NomesVertices();
                    Console.WriteLine("Vertice 1:");
                    v1 = grafo.GetVertice(int.Parse(Console.ReadLine()));
